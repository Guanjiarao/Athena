  ...
  return (
    <div className="relative flex min-h-full items-center justify-center overflow-hidden px-4 py-16 sm:px-6">
      ...
      <div className="relative w-full max-w-[860px]">
        ...
        >
          <span className="inline-flex items-center gap-2 rounded-full border border-honey-300/60 bg-honey-100/80 px-5 py-2 text-sm font-semibold text-warm-800 shadow-sm backdrop-blur">
