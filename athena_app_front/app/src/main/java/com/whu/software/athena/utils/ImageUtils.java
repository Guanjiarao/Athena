...
public class ImageUtils {
    ...
    public static Bitmap pixelate(Bitmap bitmap, int pixelSize) {
        ...
        Bitmap pixelated = Bitmap.createBitmap(width, height, Bitmap.Config.ARGB_8888);
        Canvas canvas = new Canvas(pixelated);
    ...
    public static Bitmap addWatermark(Bitmap src, String watermark) {
        ...
        paint.setTextSize(w / 10f); // Responsive text size
    ...
    // Fast Blur Implementation (Stack Blur)
