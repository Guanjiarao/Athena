...
public class FollowerListActivity extends AppCompatActivity {
    ...
    private void loadFollowerList() {
        ...
        Request request = new Request.Builder()
                .url(ApiConfig.API_FOLLOWER_LIST)
        ...
        UnsafeOkHttpClient.getUnsafeOkHttpClient().newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                mainHandler.post(() -> Toast.makeText(FollowerListActivity.this, "Request failed: " + e.getMessage(), Toast.LENGTH_SHORT).show());
            }
                ...
                try {
                    ...
                    mainHandler.post(() -> {
                        if (apiResponse != null && apiResponse.getCode() == 200) {
                            ...
                            String msg = apiResponse != null ? apiResponse.getMessage() : "Failed to get follower list";
                            Toast.makeText(FollowerListActivity.this, msg, Toast.LENGTH_SHORT).show();
                        }
                    });
                } catch (Exception e) {
                    mainHandler.post(() -> Toast.makeText(FollowerListActivity.this, "Failed to parse data", Toast.LENGTH_SHORT).show());
                }
            }
        });
    }
