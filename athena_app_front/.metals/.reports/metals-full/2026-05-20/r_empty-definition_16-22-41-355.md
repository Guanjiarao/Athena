error id: file:///D:/aa/athena-zyj%20(2)/athena_front/app/src/main/java/com/whu/software/athena/config/ApiConfig.java:
...
public class ApiConfig {
    ...
    private static final String HOST = "121.41.200.73";
    ...
    public static final String API_TRIAGE_VISION_ANALYZE = BASE_URL + "rag/triage/vision/analyze";
    ...
    public static final String API_MENSTRUATION_STATS = BASE_URL + "menstruation/stats";
    public static final String API_MENSTRUATION_MONTH = BASE_URL + "menstruation/month";
    public static final String API_MENSTRUATION_PREDICTION = BASE_URL + "menstruation/prediction";
    public static final String API_MENSTRUATION_DELETE = BASE_URL + "menstruation";

    public static final String API_RECORD_BASE = BASE_URL + "record";
    public static final String API_RECORD_DETAIL = API_RECORD_BASE + "/detail";
    public static final String API_RECORD_SAVE = API_RECORD_BASE;
    public static final String API_RECORD_UPDATE = API_RECORD_BASE;
    public static final String API_RECORD_DELETE = API_RECORD_BASE;
    public static final String API_RECORD_MARKS = API_RECORD_BASE + "/marks";

    public static final String API_INSIGHT_BASE = BASE_URL + "insight";
    public static final String API_INSIGHT_REPORT = API_INSIGHT_BASE + "/report";
    public static final String API_INSIGHT_CONTENT = API_INSIGHT_BASE + "/insight";
    public static final String API_INSIGHT_CONTENT_REFRESH = API_INSIGHT_CONTENT + "/refresh";
    public static final String API_INSIGHT_FEATURE = API_INSIGHT_BASE + "/feature";
