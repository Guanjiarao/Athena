...
public class GraphSemanticPromptBuilder {
    ...
    public String systemPrompt() {
        return "You prepare an incremental semantic update for Athena's personal cognition graph."
                ...
                + " topicTitle is the single exception to the Chinese rule below: it must be"
                + " copied verbatim from the frozen target topic title, unchanged, even when"
                + " that title is not in Chinese."
