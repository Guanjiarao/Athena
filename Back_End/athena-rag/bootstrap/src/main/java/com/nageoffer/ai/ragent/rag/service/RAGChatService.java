...
public interface RAGChatService {
     ...
     * @return 本次流式会话的元信息
     */
    ChatStreamSession streamChat(String question, String conversationId, Boolean deepThinking, StreamCallback callback);
     ...
     * 流式会话元信息
     */
    record ChatStreamSession(String conversationId, String taskId, List<ChatReferencePayload> references) {
    }
}
