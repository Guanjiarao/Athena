...
public abstract class AbstractStructuredTriageWorker {
    ...
    protected final TriageAiProperties triageAiProperties;

    protected AbstractStructuredTriageWorker(LLMService llmService, ObjectMapper objectMapper) {
        this(llmService, objectMapper, null);
    }

    protected AbstractStructuredTriageWorker(LLMService llmService, ObjectMapper objectMapper, TriageAiProperties triageAiProperties) {
        this.llmService = llmService;
        this.objectMapper = objectMapper;
        this.triageAiProperties = triageAiProperties;
    }
    ...
    protected String invokeLlm(String systemPrompt, String userPrompt, double temperature, double topP) {
        return invokeLlm(null, systemPrompt, userPrompt, temperature, topP);
    }
    ...
    protected String resolveModelId(String propertyName, String defaultModelId) {
        if (triageAiProperties == null) {
            return defaultModelId;
        }
        return switch (propertyName) {
            case "turnUnderstandingModel" -> StrUtil.blankToDefault(triageAiProperties.getTurnUnderstandingModel(), defaultModelId);
            case "factExtractorModel" -> StrUtil.blankToDefault(triageAiProperties.getFactExtractorModel(), defaultModelId);
            case "semanticParserModel" -> StrUtil.blankToDefault(triageAiProperties.getSemanticParserModel(), defaultModelId);
            case "sopValidatorModel" -> StrUtil.blankToDefault(triageAiProperties.getSopValidatorModel(), defaultModelId);
            case "riskStratifierModel" -> StrUtil.blankToDefault(triageAiProperties.getRiskStratifierModel(), defaultModelId);
            case "textModel" -> StrUtil.blankToDefault(triageAiProperties.getTextModel(), defaultModelId);
            case "reportModel" -> StrUtil.blankToDefault(triageAiProperties.getReportModel(), defaultModelId);
