...
public class TriageRegressionJudgementReportGenerator {

    public static final String SUITE_NAME = "triage-regression-judged";
    public static final Path REGRESSION_CASES_PATH = Path.of("..", "resources", "eval", "triage", "triage-regression-cases.json");
    public static final Path JSON_REPORT_PATH = Path.of("..", "resources", "eval", "outputs", "triage-regression-judged-report.json");
    public static final Path MARKDOWN_REPORT_PATH = Path.of("..", "resources", "eval", "outputs", "triage-regression-judged-report.md");
    ...
    public TriageRegressionJudgementReportGenerator() {
