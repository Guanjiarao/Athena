...
public class TriageRegressionObservedReportGenerator {

    public static final String SUITE_NAME = "triage-regression";
    public static final Path REGRESSION_CASES_PATH = Path.of("..", "resources", "eval", "triage", "triage-regression-cases.json");
    public static final Path JSON_REPORT_PATH = Path.of("..", "resources", "eval", "outputs", "triage-regression-report.json");
    public static final Path MARKDOWN_REPORT_PATH = Path.of("..", "resources", "eval", "outputs", "triage-regression-report.md");
    ...
    public TriageRegressionObservedReportGenerator() {
